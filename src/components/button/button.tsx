...
export function Button({
  ...
  const bgLightClass = bgLight
    ? "bg-[#606368] hover:bg-slate-200 hover:text-slate-800"
    : "";

  const variantClasses = {
    default: "bg-slate-200 text-[#202124] ",
    destructive: "bg-red-600 text-white hover:bg-red-700",
    outline: "border border-slate-300 bg-white hover:bg-slate-100",
    secondary: "bg-slate-700 text-white hover:bg-slate-800",
    ghost:"bg-transparent text-white hover:bg-slate-200 hover:text-slate-800 font-semibold",
    primary: "bg-transparent text-white hover:bg-slate-200 hover:text-slate-800 font-semibold",
